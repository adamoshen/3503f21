...
$$\widehat{Y} \,\pm\, t_{1-\frac{\alpha}{2},\,\text{df}}\,\widehat{\sigma}\sqrt{\frac{1}{n} \,+\, \frac{(X_{*} - \overline{X})^{2}}{\sum_{i}(X_{i} - \overline{X})^{2}}}$$
...
$$\widehat{Y} \,\pm\, t_{1-\frac{\alpha}{2},\,\text{df}}\,\widehat{\sigma}\sqrt{1 + \frac{1}{n} \,+\, \frac{(X_{*} - \overline{X})^{2}}{\sum_{i}(X_{i} - \overline{X})^{2}}}$$
