...
This is one observation with an extremely large volume.
...
There is one point that has an abnormally large volume for such a low carat value. For now, we will
ignore this point.
