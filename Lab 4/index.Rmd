...
The formula for a $100(1 - \alpha)\%$ prediction interval for $X \,=\, x_{h}$ is:

$$\widehat{y} \,\pm\, t_{1 - \frac{\alpha}{2},\, n-2} \,*\, \widehat{\sigma}\sqrt{\left(1 \,+\, \frac{1}{n} \,+\, \frac{(x_{h} - \overline{x})^{2}}{S_{xx}}\right)}$$
...
The value of $\widehat{y}$ when $x_{h} \,=\, 4$:
...
big_term <- sqrt(1 + (1/n) + (xh - xbar)^2 / Sxx)
```
