...
The degrees of freedom of our model is 1 and 182.

- The first number is the number of non-intercept parameters estimated, $p$.
- The only non-intercept parameter estimated was $\beta_{1}$

- The second number is the number of observations in our data minus the number of non-intercept
parameters estimated minus 1, $n-p-1$.
